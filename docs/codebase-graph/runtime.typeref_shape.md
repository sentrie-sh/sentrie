...
- **Dependencies Risk:**
  ...
  - **Policy shapes shadow namespace shapes here**, which is the opposite of the composition path described in [[index.shape]] — the two disagree, and that disagreement is filed as an issue.
