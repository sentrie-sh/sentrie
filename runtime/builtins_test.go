...
func (s *RuntimeTestSuite) TestFlatten_DefaultDepth() {
	...
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input)...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestFlatten_ExplicitDepth1() {
	...
	input := []any{[]any{1.0, 2.0}, []any{3.0, 4.0}}
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, 1)...)
	s.NoError(err)
	s.Equal([]any{1.0, 2.0, 3.0, 4.0}, result.Any())
}
...
func (s *RuntimeTestSuite) TestFlatten_Depth0() {
	...
	input := []any{[]any{1.0, 2.0}, []any{3.0, 4.0}}
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, 0)...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestFlatten_Depth2() {
	...
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, 2)...)
	s.NoError(err)
	s.Equal([]any{1.0, 2.0, 3.0, 4.0}, result.Any())
}
...
func (s *RuntimeTestSuite) TestFlatten_UnknownInput() {
	...
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(box.Undefined())...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestFlatten_ErrorNonList() {
	...
	_, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs("not a list")...)
	s.Error(err)
...
func (s *RuntimeTestSuite) TestFlatten_ErrorInvalidDepth() {
	...
	_, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, -1)...)
	s.Error(err)
...
func (s *RuntimeTestSuite) TestFlatten_ErrorInvalidDepthType() {
	...
	input := []any{[]any{1.0, 2.0}}
	_, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, "not an int")...)
	s.Error(err)
	s.Contains(err.Error(), "non-negative integer")
}
...
func (s *RuntimeTestSuite) TestFlatten_ErrorWrongArgCount() {
	...
	_, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
	s.Contains(err.Error(), "1 or 2 arguments")

	_, err = BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs([]any{1.0}, 1, 2)...)
	s.Error(err)
	s.Contains(err.Error(), "1 or 2 arguments")
}
...
func (s *RuntimeTestSuite) TestFlatten_UnknownDepth() {
	...
	input := []any{[]any{1.0, 2.0}}
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, box.Undefined())...)
	s.NoError(err)
	s.Equal(box.Undefined(), result) // Undefined represents unknown
}
...
func (s *RuntimeTestSuite) TestFlattenDeep_Simple() {
	...
	input := []any{[]any{1.0, 2.0}, []any{3.0, 4.0}}
	result, err := BuiltinFlattenDeep(s.T().Context(), s.builtinSite(), s.builtinArgs(input)...)
	s.NoError(err)
	s.Equal([]any{1.0, 2.0, 3.0, 4.0}, result.Any())
}
...
func (s *RuntimeTestSuite) TestFlattenDeep_UnknownInput() {
	// Unknown (undefined) input should propagate unknown
	result, err := BuiltinFlattenDeep(s.T().Context(), s.builtinSite(), s.builtinArgs(box.Undefined())...)
	s.NoError(err)
	s.Equal(box.Undefined(), result) // Undefined represents unknown
}
...
func (s *RuntimeTestSuite) TestFlattenDeep_ErrorNonList() {
	// Non-list input should return error
	_, err := BuiltinFlattenDeep(s.T().Context(), s.builtinSite(), s.builtinArgs("not a list")...)
	s.Error(err)
	s.Contains(err.Error(), "must be a list")
}
...
func (s *RuntimeTestSuite) TestFlattenDeep_ErrorWrongArgCount() {
	// Wrong argument count should return error
	_, err := BuiltinFlattenDeep(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")

	_, err = BuiltinFlattenDeep(s.T().Context(), s.builtinSite(), s.builtinArgs([]any{1.0}, 2)...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")
}
...
func (s *RuntimeTestSuite) TestAsList_ListInput() {
	...
	result, err := BuiltinAsList(s.T().Context(), s.builtinSite(), s.builtinArgs(input)...)
	s.NoError(err)
	s.Equal(input, result.Any())
}
...
func (s *RuntimeTestSuite) TestAsList_NonListInput() {
	...
	result, err := BuiltinAsList(s.T().Context(), s.builtinSite(), s.builtinArgs(42)...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestAsList_StringInput() {
	...
	result, err := BuiltinAsList(s.T().Context(), s.builtinSite(), s.builtinArgs("hello")...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestAsList_UnknownInput() {
	// Unknown (undefined) input should propagate unknown
	result, err := BuiltinAsList(s.T().Context(), s.builtinSite(), s.builtinArgs(box.Undefined())...)
	s.NoError(err)
	s.Equal(box.Undefined(), result) // Undefined represents unknown
}
...
func (s *RuntimeTestSuite) TestAsList_ErrorWrongArgCount() {
	// Wrong argument count should return error
	_, err := BuiltinAsList(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")

	_, err = BuiltinAsList(s.T().Context(), s.builtinSite(), s.builtinArgs(1, 2)...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")
}
...
func (s *RuntimeTestSuite) TestNormaliseList_SingleValue() {
	...
	result, err := BuiltinNormaliseList(s.T().Context(), s.builtinSite(), s.builtinArgs(42)...)
	s.NoError(err)
	s.Equal([]any{42.0}, result.Any())
}
...
func (s *RuntimeTestSuite) TestNormaliseList_FlatList() {
	...
	input := []any{1.0, 2.0, 3.0}
	result, err := BuiltinNormaliseList(s.T().Context(), s.builtinSite(), s.builtinArgs(input)...)
	s.NoError(err)
	s.Equal(input, result.Any())
}
...
func (s *RuntimeTestSuite) TestNormaliseList_ErrorDeeperNesting() {
	...
	_, err := BuiltinNormaliseList(s.T().Context(), s.builtinSite(), s.builtinArgs(input)...)
	s.Error(err)
...
func (s *RuntimeTestSuite) TestNormaliseList_UnknownInput() {
	// Unknown (undefined) input should propagate unknown
	result, err := BuiltinNormaliseList(s.T().Context(), s.builtinSite(), s.builtinArgs(box.Undefined())...)
	s.NoError(err)
	s.Equal(box.Undefined(), result) // Undefined represents unknown
}
...
func (s *RuntimeTestSuite) TestNormaliseList_ErrorWrongArgCount() {
	// Wrong argument count should return error
	_, err := BuiltinNormaliseList(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")

	_, err = BuiltinNormaliseList(s.T().Context(), s.builtinSite(), s.builtinArgs(1, 2)...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")
}
...
func (s *RuntimeTestSuite) TestFlatten_Int64Depth() {
	...
	input := []any{[]any{1.0, 2.0}}
	result, err := BuiltinFlatten(s.T().Context(), s.builtinSite(), s.builtinArgs(input, int64(1))...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestCount_List() {
	...
	result, err := BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs(input)...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestCount_String() {
	...
	result, err := BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs("hello")...)
	s.NoError(err)
	s.Equal(5.0, result.Any())
}
...
func (s *RuntimeTestSuite) TestCount_EmptyString() {
	...
	result, err := BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs("")...)
	s.NoError(err)
	s.Equal(0.0, result.Any())
}
...
func (s *RuntimeTestSuite) TestCount_OtherType() {
	...
	result, err := BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs(42)...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestCount_Bool() {
	...
	result, err := BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs(true)...)
	s.NoError(err)
	s.True(result.IsUndefined())
}
...
func (s *RuntimeTestSuite) TestCount_ErrorWrongArgCount() {
	// Wrong argument count should return error
	_, err := BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")

	_, err = BuiltinCount(s.T().Context(), s.builtinSite(), s.builtinArgs(1, 2)...)
	s.Error(err)
	s.Contains(err.Error(), "1 argument")
}
...
func (s *RuntimeTestSuite) TestError_SingleArgument() {
	...
	result, err := BuiltInError(s.T().Context(), s.builtinSite(), s.builtinArgs("test error")...)
	s.True(result.IsUndefined())
	s.Error(err)
...
func (s *RuntimeTestSuite) TestError_FormatString() {
	...
	result, err := BuiltInError(s.T().Context(), s.builtinSite(), s.builtinArgs("error: %s", "test")...)
	s.True(result.IsUndefined())
	s.Error(err)
...
func (s *RuntimeTestSuite) TestError_MultipleArgs() {
	...
	result, err := BuiltInError(s.T().Context(), s.builtinSite(), s.builtinArgs("%s: %d", "count", 42)...)
	s.True(result.IsUndefined())
	s.Error(err)
...
func (s *RuntimeTestSuite) TestError_ErrorWrongArgCount() {
	...
	_, err := BuiltInError(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
...
func (s *RuntimeTestSuite) TestMerge_Simple() {
	...
	result, err := BuiltinMerge(s.T().Context(), s.builtinSite(), s.builtinArgs(map1, map2)...)
	s.NoError(err)
...
func (s *RuntimeTestSuite) TestMerge_ErrorWrongArgCount() {
	// Wrong argument count should return error
	_, err := BuiltinMerge(s.T().Context(), s.builtinSite(), s.builtinArgs()...)
	s.Error(err)
	s.Contains(err.Error(), "2 arguments")

	_, err = BuiltinMerge(s.T().Context(), s.builtinSite(), s.builtinArgs(map[string]any{})...)
	s.Error(err)
	s.Contains(err.Error(), "2 arguments")

	_, err = BuiltinMerge(s.T().Context(), s.builtinSite(), s.builtinArgs(map[string]any{}, map[string]any{}, map[string]any{})...)
	s.Error(err)
	s.Contains(err.Error(), "2 arguments")
}
...
func (s *RuntimeTestSuite) TestMerge_ErrorNonMapFirst() {
	...
	_, err := BuiltinMerge(s.T().Context(), s.builtinSite(), s.builtinArgs("not a map", map[string]any{})...)
	s.Error(err)
...
func (s *RuntimeTestSuite) TestMerge_ErrorNonMapSecond() {
	...
	_, err := BuiltinMerge(s.T().Context(), s.builtinSite(), s.builtinArgs(map[string]any{}, "not a map")...)
	s.Error(err)
