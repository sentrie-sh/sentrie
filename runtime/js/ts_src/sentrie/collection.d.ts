 ...
 * Functions are organized into `list` and `map` objects.
 */
declare module "@sentrie/collection" {
  /**
   * List object provides utilities for array/list manipulation.
   */
  export const list: {
    /**
     ...
     */
    lastIndexOf(arr: any[], item: any): number;
  ...
  /**
   * Map object provides utilities for map/object manipulation.
   */
  export const map: {
    /**
     ...
     */
    keys(map: Record<string, any>): any[];
     ...
     * @throws Error if the input is not a map
     */
    values(map: Record<string, any>): any[];
     ...
     * @throws Error if the input is not a map
     */
    entries(map: Record<string, any>): [any, any][];
     ...
     */
    has(map: Record<string, any>, key: any): boolean;
     ...
     */
    get(map: Record<string, any>, key: any, defaultValue?: any): any;
     ...
     * @throws Error if the input is not a map
     */
    size(map: Record<string, any>): number;
     ...
     * @throws Error if the input is not a map
     */
    isEmpty(map: Record<string, any>): boolean;
     ...
     */
    merge(map1: Record<string, any>, map2: Record<string, any>, ...maps: Record<string, any>[]): Record<string, any>;
  };
}
