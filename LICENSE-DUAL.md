SPDX-License-Identifier: LicenseRef-Sentrie-Dual

# Sentrie Dual Licensing Notice

The Sentrie project is released under the **Apache License 2.0** for open-source use. See [LICENSE](LICENSE) for details.

The Sentrie maintainers may also choose to make the project, or parts of the project, available under separate **commercial licensing terms** for organizations that require:

- Proprietary integrations
- Dedicated support
- Additional compliance requirements
- Non–open-source redistribution rights

This dual-licensing model enables:
